...
const RenderField = ({ field, props }: { field: any, props: CustomProps }) => {
  ...
  switch (fieldType) {
    ...
    case FormFieldType.PHONE_INPUT:
      return (
        <FormControl>
          <PhoneInput defaultCountry="FR" placeholder={placeHolder} international withCountryCallingCode value={field.value as E164Number | undefined} onChange={field.onChange} className="input-phone" />
        </FormControl>
      )
      ...
      return (
        <FormControl>
          <div className="flex items-center gap-4">
            ...
            <label htmlFor={props.name} className="checkbox-label cursor-pointer">
              {props.label}
            </label>
          </div>
        </FormControl>
